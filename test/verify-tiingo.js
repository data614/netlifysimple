...
async function main() {
    ...
    await testEndpoint(`${BASE_URL}/api/env-check`, 'Environment check');
    
    console.log('\n🏁 Test complete!');
    console.log('\n💡 If you see HTML responses instead of JSON, check your redirect configuration.');
    console.log('💡 If you see "x-tiingo-fallback: mock", check your environment variables.');
}
